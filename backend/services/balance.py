...
def balance_equation(equation: str):
    ...
    def compounds_to_elements(dict: dict):
        compound_list = []
    ...
    for element in all_elements:
        ...
        for compound in reactants:
            count = 0
            if compound.get(element, 0):
                 count = compound[element]
    ...
    while anchor_row < len(matrix) and column < len(matrix[0]):
        ...
        new_line = matrix[pivot_row]

        matrix[anchor_row] = new_line
        matrix[pivot_row] = old_line
